...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--num_denoising', type=int, default=100)
        self.parser.add_argument('--reg_max',       type=int, default=32)
        self.parser.add_argument('--cls_loss_type', type=str, default='ia_bce',
                                 choices=['ia_bce', 'focal'],
                                 help="Classification loss: 'ia_bce' = IoU-aware BCE "
                                      "(VFL/RF-DETR style, default, better high-IoU AP); "
                                      "'focal' = vanilla sigmoid focal.")
