...
class opts(object):
    def __init__(self):
        ...
        # ── Stage-2 fine-tuning freeze schedule ────────────────────────────
        self.parser.add_argument('--freeze_backbone_epochs', type=int, default=5,
                                 help='Số epoch freeze toàn bộ backbone (stage 2). Default=5')
        self.parser.add_argument('--unfreeze_upper_epochs', type=int, default=5,
                                 help='Số epoch mở 1/3 cuối ViT sau freeze. Default=5')
        self.parser.add_argument('--unfreeze_ratio', type=float, default=0.34,
                                 help='Tỉ lệ block ViT mở ở giai đoạn 2. Default=0.34')
        self.parser.add_argument('--backbone_lr_ratio', type=float, default=0.05,
                                 help='backbone_lr = lr * backbone_lr_ratio. Default=0.05')
