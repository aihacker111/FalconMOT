...
# # =====================================================================
# # INTEGRATION  —  cách thay vào codebase hiện tại
# # =====================================================================
# #
# # 1) model.py
# #    - import: from .s4_module_v2 import S4FusionBranch, S4AuxiliaryHeadV2
# #    - trong FalconJDEModel.__init__ (khối if use_s4):
# #         self.s4_branch   = S4FusionBranch(sta_dim, decoder.hidden_dim,
# #                                           n_blocks=2)      # n_blocks=1 nếu cần nhanh hơn
# #         self.s4_aux_head = S4AuxiliaryHeadV2(decoder.hidden_dim)
# #    - forward giữ nguyên: out['pred_s4_aux'] = self.s4_aux_head(p2)
# #
# # 2) criterion.py  -> thay thân hàm loss_s4_aux:
# #         from .s4_module_v2 import build_center_heatmaps, gaussian_focal_loss
# #
...
# #             return losses
# #
# #    - weight_dict: 'loss_s4_aux' nâng từ 0.5 -> ~1.0 (focal loss thang nhỏ hơn).
# #
# # 3) (tuỳ chọn tốc độ) chuyển build_center_heatmaps sang collate_fn của dataloader,
# #    cache theo eval/train size, để bước training chỉ còn 1 lần gaussian_focal_loss.
