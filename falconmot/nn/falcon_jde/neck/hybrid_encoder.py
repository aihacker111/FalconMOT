...
from ..ops.utils import get_activation
...
# --- Improvement: high-res learned upsample & content-aware gate ---

class LightUpsample(nn.Module):
    """Bilinear x2 upsample (0 params, ~0 FLOPs) - RT-DETR/DEIM style.
    Replaces the learned PixelShuffle (conv 192->768 3x3) that cost ~2.66M params."""
...
class HybridEncoder(nn.Module):
    ...
    def __init__(self,
                 in_channels=[256, 256, 512, 1024], # supports either 3 or 4 input levels (incl. S4)
        ...
        # Channel projection to bring every input scale to hidden_dim
        ...
        # Build the top-down FPN structure
        ...
        # Build the bottom-up PAN structure
        ...
        # Add the learned upsample block and the content-aware gating
    ...
    def forward(self, feats):
        ...
        # Run the transformer block on the specified levels (e.g. S32)
        ...
        # --- 1. TOP-DOWN FPN LOOP (learned upsample + gated fusion) ---
        ...
        for idx in range(len(self.in_channels) - 1, 0, -1):
            ...
            # Lightweight bilinear upsample to restore spatial resolution
            upsample_feat = self.upsamplers[len(self.in_channels) - 1 - idx](feat_heigh)

            # Use content-aware gated fusion instead of a plain element-wise add
        ...
        # --- 2. BOTTOM-UP PAN LOOP (with gated fusion) ---
        outs = [inner_outs[0]]
        for idx in range(len(self.in_channels) - 1):
            ...
            # Gated fusion in the bottom-up pass to filter shallow-level noise
