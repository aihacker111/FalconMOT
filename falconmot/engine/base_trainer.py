...
from falconmot.utils.utils import AverageMeter
from falconmot.models.data_parallel import DataParallel  # multi-GPU wrapper (was missing)
    ...
    def run_epoch(self, phase, epoch, data_loader, scheduler=None):
        ...
        for batch_i, batch in enumerate(data_loader):
            ...
            with torch.amp.autocast('cuda', enabled=use_amp):
                output, loss, loss_stats = model_with_loss.forward(batch, epoch)
